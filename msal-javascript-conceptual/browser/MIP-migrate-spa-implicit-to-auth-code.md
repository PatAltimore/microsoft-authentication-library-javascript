...
You can also [create a new app registration](/entra/identity-platform/scenario-spa-app-registration) instead of updating the redirect URIs in your existing registration.
